...
const specialPoints = [
  { lat: PARIS.lat, lng: PARIS.lng, color: '#00a6ff', size: 3 },
]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="flex flex-col justify-center">
            ...
            <p className="text-base md:text-lg text-muted-foreground mb-6 leading-relaxed text-pretty max-w-lg">
              Des systèmes conçus ici, performants partout. Clyvuum redonne aux entreprises leur ressource la plus précieuse&nbsp;: le temps.
            </p>
          </div>
